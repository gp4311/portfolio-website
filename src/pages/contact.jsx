    ...
    return (
        <div className='p-10'>
            <section id='form' className='flex flex-col justify-center items-center pb-10 gap-10'>
                <div className='pt-10 text-text-color text-center'>
            ...
            <section id='other-methods' className='pb-10'>
                <div className='text-text-color text-center pb-5'>
                    <p className='font-body'>or feel free to reach out using one of the methods below:</p>
                </div>
                <div className='flex gap-5 justify-center'>
                    {
                        social.map((s, key) => (
                            <a key={key} href={s.to} target='_blank' rel='noreferrer' className='text-text-color hover:text-color-1a transition duration-500'>
                                {s.icon}
                            </a>
                        ))
                    }
